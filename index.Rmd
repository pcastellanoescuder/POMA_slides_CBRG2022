...
$$feature \sim \beta_0 + age + gender + group$$
---
...
$$feature \sim \beta_0 + group + age + smoking$$
...
$$group \sim \beta_0 + smoking + alcohol + age + \sum_{i=1}^p feature_i$$
...
<img src="img/questions.jpeg" height="250">
